...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataTransformationArtifact:
        ...
        try:
            ...
            train_df_column_status=self.is_required_column_exist(base_df=base_df, current_df=train_df, report_key_name="Missing_columns_in_train_dataset")
            logging.info("Is all required columns present in test df")
            test_df_column_status=self.is_required_column_exist(base_df=base_df, current_df=test_df, report_key_name="Missing_columns_in_test_dataset")
